...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_TABLE_Q0513 = "coaeat";
    ...
    private static final String Creat_Table_Q0501 = "CREATE TABLE " + DB_TABLE_Q0501 + " ( "
            + "id INTEGER PRIMARY KEY," + "name TEXT NOT NULL," + "tel TEXT," + "text1 TEXT," + "text2 TEXT) ;" ;
...
//抓出整筆資料
    ...
    //抓出整筆資料
    public ArrayList<String> ngetRecSet_query_Q0401(String tname, String tgrp, String taddr) {
        SQLiteDatabase db = getReadableDatabase();
